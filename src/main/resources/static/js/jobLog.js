$(function() {
	...
	$("#userDataTable").bootstrapTable({ // 对应table标签的id
	      url: "job/getElasticJobConfigLogList", // 获取表格数据的url
	      ...
	      columns: [
	    	  {
	              ...
	              formatter: function (value, row, index) {
	                  return '<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal" onclick="shows(\'' + value + '\')">查看</button>';
	              }
	          }
	      ],
